...
if(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
  if(CMAKE_CXX_COMPILER_VERSION VERSION_LESS RENDU_MSVC_EXPECTED_VERSION)
    message(FATAL_ERROR "MSVC: RenduCore requires version ${RENDU_MSVC_EXPECTED_VERSION} (${RENDU_MSVC_EXPECTED_VERSION_STRING}) to build but found ${CMAKE_CXX_COMPILER_VERSION}")
  else()
    message(STATUS "MSVC: Minimum version required is ${RENDU_MSVC_EXPECTED_VERSION}, found ${CMAKE_CXX_COMPILER_VERSION} - ok!")
  endif()
endif()
...
message(STATUS "MSVC: 安全相关宏定义已设置")
