if(CMAKE_VERSION VERSION_LESS "3.16.0")
  ...
  function(ADD_CXX_PCH TARGET_NAME_LIST PCH_HEADER)
    ...
    foreach(target-name ${TARGET_NAME_LIST})
      # 禁用unity版本
      set_target_properties(${target-name} PROPERTIES COTIRE_ADD_UNITY_BUILD OFF)
      # 设置前缀头
      set_target_properties(${target-name} PROPERTIES COTIRE_CXX_PREFIX_HEADER_INIT ${PCH_HEADER})
      # 代码错误的解决方法: https://github.com/sakra/cotire/issues/138
      set_property(TARGET ${target-name} PROPERTY CXX_STANDARD 17)
    endforeach()
